          ...
          <PrimaryButton
            onClick={() => {
              ...
              webApp?.openTelegramLink(
                `https://t.me/share/url?url=${getLinkToApp(referralsData.link, false)}&text=🎁 500,000 free tokens are already waiting for you in Majestic! ⭐️ I invite you to the game`,
              );
            }}
          >
