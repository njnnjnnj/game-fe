...
export const TID_BY_SHOP_ITEM_TYPE = {
  ...
  [ShopItemTypeEnum.BOOSTER]: NS.PAGES.SHOP.SHOP_TYPE.BOOSTER,
  [ShopItemTypeEnum.BATTLE_PASS]: NS.PAGES.SHOP.SHOP_TYPE.AUTO_COLLECT,
  [ShopItemTypeEnum.OFFLINE_BONUS]: NS.PAGES.SHOP.SHOP_TYPE.AUTO_COLLECT,
  [ShopItemTypeEnum.GAME_ENERGY]: NS.PAGES.SHOP.SHOP_TYPE.GAME_ENERGY,
