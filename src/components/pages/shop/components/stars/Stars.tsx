...
import TapeImage from "@/public/assets/png/shop/tape-3.webp";
import { ShopItem } from "@/services/shop/types";
import { formatNumber } from "@/utils/number";

import { STARS_CARDS } from "../../constants";
...
export const Stars: FunctionComponent<Props> = ({ cards, onSelect }) => {
    ...
    <>
      ...
      <div className="relative mb-8 grid w-full grid-cols-3 gap-2">
        {cards.map((card, index) => {
          const staticCardData = STARS_CARDS[index];
