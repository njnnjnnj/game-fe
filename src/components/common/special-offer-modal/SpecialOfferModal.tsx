      ...
      <div className="z-10 mb-6 mt-auto flex flex-col items-center gap-3">
        <div
          className={classNames(
            "text-stroke-half mx-auto flex items-center gap-2 self-start rounded-full bg-gradient-to-tr from-[#FF8E01] to-[#DD342C] px-3 pt-1 pb-1.5 text-lg font-extrabold text-shadow text-white",
          )}
        >
          {t(
